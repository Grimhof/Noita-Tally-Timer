...
function script_properties()
	...
	obs.obs_properties_add_text(props, "reset_hotkey_name", "Reset Hotkey Name", obs.OBS_TEXT_DEFAULT)
    obs.obs_properties_add_text(props, "up_count_hotkey_name", "Up Count Hotkey Name", obs.OBS_TEXT_DEFAULT)
    obs.obs_properties_add_text(props, "down_count_hotkey_name", "Down Count Hotkey Name", obs.OBS_TEXT_DEFAULT)
...
function script_update(settings)
	...
	reset_hotkey_name = obs.obs_data_get_string(settings, "reset_hotkey_name")
    up_count_hotkey_name = obs.obs_data_get_string(settings, "up_count_hotkey_name")
    down_count_hotkey_name = obs.obs_data_get_string(settings, "down_count_hotkey_name")
...
function script_defaults(settings)
    ...
    obs.obs_data_set_default_string(settings, "format_text", "%d")
end
...
function script_save(settings)
    ...
    obs.obs_data_set_array(settings, "reset_hotkey", hotkey_reset_save_array)
...
function script_load(settings)
    ...
    -- Retrieve the user-defined hotkey names from the script settings
    local reset_hotkey_name = obs.obs_data_get_string(settings, "reset_hotkey_name")
    local up_count_hotkey_name = obs.obs_data_get_string(settings, "up_count_hotkey_name")
    local down_count_hotkey_name = obs.obs_data_get_string(settings, "down_count_hotkey_name")

    -- Register the hotkeys with the user-defined names
    hotkey_reset_id = obs.obs_hotkey_register_frontend("reset_button_thingy", reset_hotkey_name, reset)
    hotkey_up_id = obs.obs_hotkey_register_frontend("up_button_thingy", up_count_hotkey_name, count_up)
    hotkey_down_id = obs.obs_hotkey_register_frontend("down_button_thingy", down_count_hotkey_name, count_down)
